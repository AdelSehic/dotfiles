...
theme.wallpaper                                 = theme.confdir .. "/home/adel/Pictures/Wallpapers/0053.jpg"
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(28), bg = theme.bg_normal .. "aa", fg = theme.fg_normal })
